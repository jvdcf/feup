...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF179299);
  late Color secondary = const Color(0xFF006D6F);
  late Color tertiary = const Color(0xFFEE8B60);
  late Color alternate = const Color(0xFF8CAAEE);
  late Color primaryText = const Color(0xFF14181B);
  late Color secondaryText = const Color(0xFF57636C);
  late Color primaryBackground = const Color(0xFFF1F4F8);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFCBA6F7);
  late Color accent2 = const Color(0xFFFAB387);
  late Color accent3 = const Color(0xFF91D7E3);
  late Color accent4 = const Color(0xFF939AB7);
  late Color success = const Color(0xFF249689);
  late Color warning = const Color(0xFFF9CF58);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFFFFFFF);

  late Color work = const Color(0xFFCA9EE6);
  late Color food = const Color(0xFFEF9F76);
  late Color drink = const Color(0xFF99D1DB);
  late Color sleep = const Color(0xFFCCCCCC);
  late Color custom = const Color(0xFF8CAAEE);
}
