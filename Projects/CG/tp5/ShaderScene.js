...
export class ShaderScene extends CGFscene {
	...
	init(application) {
		...
		this.testShaders = [
			...
			new CGFshader(this.gl, "shaders/animationXX.vert", "shaders/yellow_blue.frag"),
		...
		this.testShaders[12].setUniformsValues({ uSampler3: 2 });
		this.testShaders[12].setUniformsValues({ uSampler4: 3 });
