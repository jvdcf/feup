...
export class MyScene extends CGFscene {
  ...
  init(application) {
    ...
    this.triangleCheck = true;
    this.parallelogramCheck = true;
    this.triangleSmallCheck = true;
    this.triangleBigCheck = true;
  }
  initLights() {
  ...
  display() {
    ...
    if (this.parallelogramCheck) this.parallelogram.display();
