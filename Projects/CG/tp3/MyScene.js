...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood texture (brown, low specular)
        this.woodMaterial = new CGFappearance(this);
        this.woodMaterial.setAmbient(0.643, 0.455, 0.286, 1.0);
        this.woodMaterial.setDiffuse(0.643, 0.455, 0.286, 1.0);
        this.woodMaterial.setSpecular(0.321, 0.227, 0.143, 0.25);
